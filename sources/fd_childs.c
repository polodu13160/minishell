...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/04 03:17:49 by pde-petr          #+#    #+#             */
/*   Updated: 2025/06/04 04:40:49 by pde-petr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_perm_infiles(t_minishell *minishell, int i, int j, t_pip *exec)
{
	...
	{
		dprintf(2,"pipe %dinfile %s",i,minishell->pipex[i].infiles[--j].value);
...
int	ft_check_perm(t_pip *exec, t_minishell *minishell, int i)
{
	...
	{
		dprintf(2,"pipe %d outfile = %s",i,minishell->pipex[i].infiles[j].value);
	}
