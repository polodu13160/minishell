...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   check_perm_infiles.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: pde-petr <pde-petr@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/04 05:22:48 by pde-petr          #+#    #+#             */
/*   Updated: 2025/08/18 13:11:29 by pde-petr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ignore_outfiles_infiles_if_error(t_minishell *minishell,
		int index_error_outfiles, int index_error_infiles, int i)
{
	int	j;
...
int	check_perm(t_pipe *exec, t_minishell *minishell, int i)
{
	...
	error = 0;
	init_exec_loop(exec);
	index_error_infiles = count_tokens_error_files_and_ignore
		(minishell->pipex[i].infiles, T_REDIRECT_IN, -1, -1);
	index_error_outfiles = count_tokens_error_files_and_ignore
		(minishell->pipex[i].outfiles, T_REDIRECT_OUT, -1, -1);
	ignore_outfiles_infiles_if_error(minishell, index_error_outfiles,
		index_error_infiles, i);
